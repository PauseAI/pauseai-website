---
title: PauseAI Safeguarding Protocol
description: How PauseAI identifies, responds to, and prevents harm across all community spaces, including in-person events and online platforms.
---
...
This protocol should be read alongside the PauseAI [Code of Conduct](/code-of-conduct) and [Sexual Harassment Policy](/sexual-harassment-policy).
...
2. **Report to the DSC.** Contact the Designated Safeguarding Contact at [safeguarding@pauseai.info](mailto:safeguarding@pauseai.info) as soon as possible.
...
- Any participant who reports a concern via Discord should be directed to contact the DSC at [safeguarding@pauseai.info](mailto:safeguarding@pauseai.info).
...
- Alcohol/substance policy communicated (see [Code of Conduct](/code-of-conduct))
...
- **Submit via the secure channel.** Send your notes to [safeguarding@pauseai.info](mailto:safeguarding@pauseai.info). Do NOT store safeguarding records in the general Notion workspace, shared folders, or personal devices.
