---
title: Building the Pause Button (2025 archive)
slug: building-the-pause-button-2025
description: The original 2025 walkthrough of the AI chip supply chain and the tools for enforcing a pause. Kept for reference; the refreshed page is at /building-the-pause-button.
---

_This is the original 2025 version of this page, kept as a historic record. Some figures are out of date. For the current version, see [Building the Pause Button](/building-the-pause-button), [The Dutch Pause Button](/asml-pause-button) and [The US-China Pause Button](/us-china-pause-button)._
