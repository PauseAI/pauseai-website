...
2. **Add your group** to the `local-communities` channel on our [Discord](https://pauseai.info/join). Add the invite link from that chat group in the thread on Discord. The moderators will add your local group to the [communities page](/communities) on this website, and use your link.
...
If you’re struggling with any aspect of local organizing, you can also discuss this in the local-organizers channel on the [PauseAI Discord](https://pauseai.info/join), and others will be happy to help you out and provide feedback.
