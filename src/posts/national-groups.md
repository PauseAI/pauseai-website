...
1.  Reach out to the Oversight team at PauseAI global. They can help with funding, support, materials.
1.  Create materials
    ...
    1.  **Website**? You can do this in three ways:
        1.  Wait until PauseAI.info offers automated translations. Perhaps you can have your own page on the pauseai.info website. E.g. [PauseAI NYC](https://pauseai.info/nyc-action).
        1.  Clone the PauseAI github repo, translate it and adjust to taste! We can help host it if needed.
        1.  Make your own custom website, like [PauseIA](https://pauseia.fr/) did
1.  Set up internal communication channel / group chat
    1.  e.g. WhatsApp / Signal / Telegram / Discord.
    1.  Choose something popular to maximize engagement
1.  Set up **Social media accounts**. (e.g. X, Instagram, LinkedIn, TikTok)
    1.  Consider which tools are important for your country and target audience.
    1.  Consider a tool like Buffer to schedule posts. Look at PauseAI X posts for inspiration. You can plan a whole list in one go!
1.  **Recruitment**. Get people to join your group.
    1.  Find people in relevant groups (EA, AI safety)
    1.  Take advantage of any networking events
    1.  [Flyering](https://pauseai.info/flyering) / Tabling (especially in student group fairs at college campuses)
    1.  Launch event
        1.  Maxime did this for PauseIA FR
        1.  Rent a nice location a few months in advance
        1.  Invite good speakers, journalists, relevant people, potential volunteers
        1.  Get reimbursed for the costs by PauseAI
        1.  This is how you can get know quickly!
    1.  [Local Organizing Guide](/local-organizing) has some advice on recruitment which may transfer well to national level
1.  Set up **activities**
    1.  Posting things to your socials
    1.  Workshops (e.g. lobby workshop, protest workshop)
    1.  Lobbying directly
    1.  Media outreach / journalist outreach
    1.  Protesting
        1.  Perhaps in multiple cities, or one larger in one location
        1.  [Read more here](https://pauseai.info/organizing-a-protest)
