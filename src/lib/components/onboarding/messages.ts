...
const en: OnboardingMessages = {
	...
	onboarding_intent_volunteer_sub: 'Help me find a role that fits (includes local chapter updates).',
	onboarding_intent_lead_label: 'I want to lead',
	onboarding_intent_lead_sub: "I'm ready to organize in my country or region (includes local chapter updates).",
